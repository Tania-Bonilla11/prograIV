let symbols = ['bus', 'bus', 'car', 'car', 'bed', 'bed', 'motorcycle', 'motorcycle', 'cutlery', 'cutlery', 'wheelchair', 'wheelchair', 'plane', 'plane', 'ambulance', 'ambulance'],
    opened = [],
    match = 0,
    Clicks = 0,
...
function endGame(Clicks, score) {
    swal({
        ...
        title: 'Feliciddades! Ganste!',
        text: 'With ' + Clicks + ' Clicks y ' + score + ' estrellas en ' + second + ' Segundos.\n Woooooo!',
        type: 'success',
...
$PlayAgain.bind('click', function () {
    swal({
        allowEscapeKey: false,
        allowOutsideClick: false,
        title: '¿Ya Te rendiste?',
        text: "¿Estas seguro? Sr./Sra Aguafiestas",
        type: 'warning',
        showCancelButton: true,
        confirmButtonColor: '#02ccba',
        cancelButtonColor: '#f95c3c',
        confirmButtonText: 'Si, Soy Aguafiestas',
    }).then(function (isConfirm) {
        if (isConfirm) {
            initGame();
        }
